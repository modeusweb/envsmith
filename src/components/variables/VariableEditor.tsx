...
interface VariableEditorProps {
  ...
  /** Closing plays the exit animation, so keep the sheet rendered and flip this flag instead. */
  open: boolean;
  onUpdate: (patch: Partial<EnvVariable>) => void;
  onClose: () => void;
}

export function VariableEditor({ variable, open, onUpdate, onClose }: VariableEditorProps) {
  ...
  return (
    <Modal
      ...
      variant="sheet"
      className="w-full max-w-md border-l border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-xl"
    >
